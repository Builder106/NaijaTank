...
const FIELD_MASK = [
  ...
  // 'editorialSummary', // Consider if needed, and attribution requirements
  // 'generativeSummary', // Consider if needed, and attribution requirements
  // 'fuelOptions', // Enterprise SKU - investigate if available/needed
].join(',');
